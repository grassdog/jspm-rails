...
describe('es6-classes', function() {
  ...
  describe('ClassDeclarations', function() {
    describe('preserves line numbers', function() {
      it('does not add "use strict" unless necessary', function() {
        ...
        var expected = ['function strictStuff() {', '  "use strict";', '  function A(){}', '    A.prototype.foo=function() {};', '  ', '}', 'function B(){"use strict";}', '  B.prototype.bar=function() {"use strict";', '    function C(){}', '  };', ''].join('\n');
  ...
  describe('handles reserved words', function() {
    it('handles reserved words', function() {
      expect(transform(['class Foo {', '  delete(x, y) {', '    bar();', '  }', '}'].join('\n'))).toBe(['function Foo(){"use strict";}', '  Foo.prototype["delete"]=function(x, y) {"use strict";', '    bar();', '  };', ''].join('\n'));
    });
  });
  describe('preserve newlines', function() {
    it('preserve newlines', function() {
      expect(transform(['class Foo {', '  A', '   (', '     x, y) {', '    bar();', '  }', '}'].join('\n'))).toBe(['function Foo(){"use strict";}', '  Foo.prototype.A=function(', '', 'x, y) {"use strict";', '    bar();', '  };', ''].join('\n'));
    });
  });
});
